...
### Sorting all persons by name in increasing alphabetical order: `sort`
Shows a list of all persons in the address book, sorted by name in increasing alphabetical order.<br>
Format: `sort`
